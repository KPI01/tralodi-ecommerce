      ...
      <div className='card-body text-primary'>
        ...
        <div id='card-actions' className='d-flex justify-content-between'>
          ...
          <div className='input-group input-group-sm' style={{ maxWidth: 'fit-content' }}>
            <button className='btn btn-sm btn-secondary text-primary' style={{ fontSize: '1.3rem', lineHeight: '.9rem' }} onClick={() => handleReduce(refCant.current)}>-</button>
            <input type='text' className='form-control form-control-sm text-center' style={{ width: '5ch', maxWidth: '40px' }} value={itemCant} readOnly />
